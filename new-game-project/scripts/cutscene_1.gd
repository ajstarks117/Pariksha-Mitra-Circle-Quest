...
आपण खोलात जाऊन या घटनेमागची संकल्पना उलगडूया.
	...
	[font_size=32]परीघ आणि व्यास यांचा संबंध समजून घेणे :[/font_size]
...
तुम्ही हे नातं एक्सप्लोर करायला तयार आहात का? आपण एकत्र शिकूया!",
	"[center][color=white]वर्तुळाच्या परीघाचे त्याच्या व्यासाशी असलेले गुणोत्तर एक स्थिर संख्या आहे, अंदाजे ३.१४, ज्याला पाय (pi) म्हणून ओळखले जाते.[/color][/center]
	...
	[/color][/center]
	[center][color=white]परीघ ÷ व्यास  = पाय(pi)[/color][/center]
	[center][color=white]व्यवहारात, आपण पाय(pi) अंदाजे ३.१४ किंवा २२/७ म्हणून गृहीत धरतो, परंतु ही एक अतार्किक संख्या आहे, म्हणजे ती पुनरावृत्ती न करता कायमचालू राहते![/color][/center]",
	"[center][color=white]आता, वर्तुळाचा परिघ मोजण्यासाठी, जर आपल्याला व्यास माहित असेल तर आपण सूत्र वापरू शकतो:[/color][/center]
	[center][color=white]परीघ = पाय(pi) × व्यास[/color][/center]
	[center][color=white]परंतु जर आपल्याला त्रिज्या माहित असेल तर आपण सूत्र देखील वापरू शकतो:[/color][/center]
	[center][color=white]c = २ × पाय(pi) × त्रिज्या[/color][/center]
	[center][color=white]त्यामुळे व्यास आणि त्रिज्या आणि पाय(pi) विशेष संख्या यांचा संबंध समजून घेऊन आपण कोणत्याही वर्तुळाचा परीघ मोजू शकतो![/color][/center]"
]

var audio_files = [
	"res://assets/Voices/Dialogue-1.mp3",
	"res://assets/Voices/Dailogue-2.mp3",
	"res://assets/Voices/Dialogue-3.mp3"
]
